...
class _AppBarWidget extends State<AppBarWidget> {
  AiModelDataDTO _selectedItem = new AiModelDataDTO(name: 'No model', url: 'No', maxLimit: 0, used: 0);
              ...
              child: GestureDetector(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border.all(
                        color: _isModelDialogOpen ? Colors.deepPurpleAccent.withOpacity(0.3) : Colors.grey[300]!,
                        width: _isModelDialogOpen ? 2.5 : 1.5),
                    borderRadius: BorderRadius.circular(10),
                    boxShadow: [
                      BoxShadow(
                        color: _isModelDialogOpen ? Colors.deepPurpleAccent.withOpacity(0.25) : Colors.black.withOpacity(0.05),
